...
<section class="content">
  <div class="row">
    ...
    $body=[];
    $body[]="AdminLteTurbo is a php classed, striped down version of <a href='https://almsaeedstudio.com/'>Almaseed AdminLTE2</a> which is based on <a href='http://getbootstrap.com/'>bootstrap</a><br />";
    ...
    $foot=[];
    $foot[]="<a href='config.php' class='btn btn-default'><i class='fa fa-wrench'></i> Configuration</a> ";
    $foot[]="<a href='examples.php' class='btn btn-default'><i class='fa fa-list'></i> Examples</a> ";
    $box->footer($foot);
