...
<div class="login-box">
      <div class="login-logo">
        <a href="../../index2.html"><b>Admin</b>LTE<i>Turbo</i></a>
      </div><!-- /.login-logo -->
...
<div class='row'>
	...
	<div class='col-md-4'>
		This is just a login page example, the menu has been colapsed with :
		<pre>$("body").toggleClass('sidebar-collapse');</pre>
	</div>
	<div class='col-md-4'></div>
</div>
